...
// CPhipps - now they're the doom codes, so default.cfg can be portable
  ...
  {"mus_e2m4", {0,&S_music_files[mus_e2m4]}, {0,"music/e2m4.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e2m5", {0,&S_music_files[mus_e2m5]}, {0,"music/e1m7.mp3"},UL,UL,
   def_str,ss_none},
  ...
  {"mus_e2m8", {0,&S_music_files[mus_e2m8]}, {0,"music/e2m8.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e2m9", {0,&S_music_files[mus_e2m9]}, {0,"music/e3m1.mp3"},UL,UL,
   def_str,ss_none},
  ...
  {"mus_e3m3", {0,&S_music_files[mus_e3m3]}, {0,"music/e3m3.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m4", {0,&S_music_files[mus_e3m4]}, {0,"music/e1m8.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m5", {0,&S_music_files[mus_e3m5]}, {0,"music/e1m7.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m6", {0,&S_music_files[mus_e3m6]}, {0,"music/e1m6.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m7", {0,&S_music_files[mus_e3m7]}, {0,"music/e2m7.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m8", {0,&S_music_files[mus_e3m8]}, {0,"music/e3m8.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_e3m9", {0,&S_music_files[mus_e3m9]}, {0,"music/e1m9.mp3"},UL,UL,
   def_str,ss_none},
  {"mus_inter", {0,&S_music_files[mus_inter]}, {0,"music/e2m3.mp3"},UL,UL,
   def_str,ss_none},
